...
<template>
  <div :class="$style.carDetails">
      ...
      <div :class="$style.textImgsParent">
          <div :class="$style.textImgs">
              <div :class="$style.textImg">
                  <div :class="$style.textImg">
                      <div :class="$style.teslaModelS">Tesla Model S Plaid</div>
                      <div :class="$style.text1">
                          <div :class="$style.teslaModelS">400Zł</div>
          ...
          <div :class="$style.textCardsButton">
              <div :class="$style.textCards">
                  <div :class="$style.teslaModelS">Specyfikacja techniczna</div>
                  <div :class="$style.cards">
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.teslaModelS">Skrzynia biegów</div>
                      ...
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.teslaModelS">Paliwo</div>
                              <div :class="$style.automat">Elektryczny</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          <img :class="$style.g17Icon" alt="" src="@/assets/g3353.png" />
                          <div :class="$style.text2">
                              <div :class="$style.teslaModelS">Drzwi</div>
                      ...
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.teslaModelS">Klimatyzator</div>
                      ...
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.teslaModelS">Miejsca</div>
                              <div :class="$style.automat">4</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.teslaModelS">Dystans</div>
              ...
              <div :class="$style.textIcons">
                  <div :class="$style.teslaModelS">Wyposażenie samochodu</div>
      ...
      <div :class="$style.banner">
          <div :class="$style.teslaModelSContainer">
              <p :class="$style.cieszSiYciem">Tesla Model S Plaid to samochód elektryczny z trzema silnikami, który oferuje niespotykane dotąd wrażenia. Pojazd jest w stanie przyspieszyć od 0 do 100 km/h w zaledwie 2,1 sekundy i osiągnąć prędkość maksymalną wynoszącą 280 km/h. Ponadto, samochód oferuje zasięg około 630 km na jednym ładowaniu oraz wiele zaawansowanych funkcji, takich jak autopilot, adaptacyjny tempomat czy panoramiczny dach szklany. </p>
              <p :class="$style.cieszSiYciem">Jeśli jesteś miłośnikiem szybkich i innowacyjnych samochodów, to wynajem Tesla Model S Plaid może być idealnym rozwiązaniem dla Ciebie. Wynajem Tesla Model S Plaid to także świetna okazja do przetestowania samochodu przed ewentualnym zakupem lub w celach rekreacyjnych.</p>
          </div>
