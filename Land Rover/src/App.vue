...
<template>
  <div :class="$style.carDetails">
      ...
      <div :class="$style.textImgsParent">
          <div :class="$style.textImgs">
              <div :class="$style.textImg">
                  <div :class="$style.textImg">
                      <div :class="$style.landRover">Land Rover </div>
                      <div :class="$style.text1">
                          <div :class="$style.landRover">350Zł</div>
          ...
          <div :class="$style.textCardsButton">
              <div :class="$style.textCards">
                  <div :class="$style.landRover">Specyfikacja techniczna</div>
                  <div :class="$style.cards">
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.landRover">Skrzynia biegów</div>
                      ...
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.landRover">Paliwo</div>
                              <div :class="$style.automat">Benzyna</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          <img :class="$style.g17Icon" alt="" src="@/assets/g3353.png" />
                          <div :class="$style.text2">
                              <div :class="$style.landRover">Drzwi</div>
                      ...
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.landRover">Klimatyzator</div>
                              <div :class="$style.automat">Tak</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          <img :class="$style.g17Icon" alt="" src="@/assets/Mask group.png" />
                          <div :class="$style.text2">
                              <div :class="$style.landRover">Miejsca</div>
                              <div :class="$style.automat">5</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/free-icon-distance-9709725 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.landRover">Dystans</div>
                              <div :class="$style.automat">500 </div>
                          </div>
                      </div>
                  </div>
              </div>
              <div :class="$style.button1">
                  <div :class="$style.zarezerwuj">Wynajmij samochód</div>
              </div>
              <div :class="$style.textIcons">
                  <div :class="$style.landRover">Wyposażenie samochodu</div>
      ...
      <div :class="$style.banner">
          <div :class="$style.landRoverRangeContainer">
              <p :class="$style.cieszSiYciem">Land Rover Range Rover D300 – opis pojazduLand Rover Range Rover stanowi ciekawą alternatywę nie tylko dla takich aut jak BMW X7 czy Mercedes GLS, ale również Bentley Bentayga czy Porsche Cayenne. Ze wszystkich wymienionych wyróżnia się indywidualnym stylem, znakomitymi właściwościami terenowymi oraz nastawieniem bardziej na luksus i komfort niż na właściwości sportowe. Model ten ma już ponad 50-letnią historię, a jego najnowsze wcielenie – generacja piąta o oznaczeniu L460 jest zwieńczeniem dopracowywania konstrukcji do perfekcji.</p>
              <p :class="$style.cieszSiYciem">Land Rover Range Rover D300 – parametry techniczne. Land Rover Range Rover D300 oferuje zaawansowane parametry techniczne, w tym system monitorowania ciśnienia w oponach dla optymalnego bezpieczeństwa na drodze oraz system rozpoznawania znaków drogowych, który wspiera kierowcę w zachowaniu zgodności z przepisami. Model wyposażony jest również w system rozpoznawania przeszkód, a także system zapobiegający kolizjom, podnosząc bezpieczeństwo jazdy. Eleganckie tylne kierunkowskazy uzupełniają nowoczesny design pojazdu, który jest dostępny także na wynajem długoterminowy – idealne rozwiązanie dla osób ceniących komfort i innowacje.</p>
              <p :class="$style.cieszSiYciem">Land Rover Range Rover D300 wyróżnia się również innymi luksusowymi rozwiązaniami technicznymi, takimi jak centralna konsola z intuicyjnym układem, podświetlane lusterka poprawiające komfort użytkowania, oraz solidna skrzynia biegów zapewniająca płynną zmianę przełożeń. Podobnie jak model Discovery Sport, Range Rover D300 został zaprojektowany do pokonywania różnych terenów, a napęd na cztery koła gwarantuje doskonałą przyczepność i stabilność. Marka Land Rover stawia na elegancję i nowoczesne technologie, idealne na codzienną jazdę oraz długie podróże.</p>
              <p :class="$style.cieszSiYciem">Nowoczesny design Range RoveraNowy „Range” został zdecydowanie unowocześniony w porównaniu do poprzednika. Wizualnie nie jest diametralnie inny, ale wszystkie linie zostały znacznie „wygładzone”. Sylwetka jest bardzo spójna i smukła mimo olbrzymich rozmiarów. Ten sam styl jest kontynuowany we wnętrzu auta. Bardzo luksusowe, doskonale wykończone z dużym ekranem centralnym Pivi Pro o przekątnej 13’1, jednak w pewien sposób minimalistyczne i nieprzeładowane przyciskami. Atmosfera kabiny wraz z rewelacyjnym komfortem jazdy (w dużej mierze za sprawą obecności pneumatycznego zawieszenia) oraz perfekcyjnym wyciszeniem (aktywna redukcja hałasu) sprawia, że jest to jedna z najlepszych możliwych propozycji na dłuższe trasy. Do tego dochodzi niepowtarzalna, wysoka pozycja za kierownicą, zapewniająca doskonałą widoczność oraz poczucie bezpieczeństwa. Mimo swoich rozmiarów, za sprawą tylnej skrętnej osi, ponad 5-metrowy SUV radzi sobie nadzwyczaj dobrze w warunkach miejskich! Producent poprawił również zachowanie L460 w zakrętach za sprawą aktywnego systemu kontroli przechyłu oraz usztywnieniu całej konstrukcji o 35%.  Jeżeli szukacie dużego SUV-a, którego naturalnym środowiskim są zakręty, warto sprawdzić z kolei Porsche Cayenne. Oczywiście nie zapomniano o korzeniach marki i za sprawą systemu Terrain Response 2, Land Rover dojedzie tam, gdzie żaden inny konkurent.</p>
              <p :class="$style.cieszSiYciem">Tak ekskluzywne auto musi być odpowiednio wyposażone. Na pokładzie znajdziemy panoramiczny dach szklany, elektryczną klapę bagażnika sterowaną gestami, ambientowe oświetlenie, bezprzewodową ładowarkę, aktywny tempomat, Apple CarPlay, nagłośnienie Meridian, automatyczną trzystrefową klimatyzację i kamery 360 stopni. Samochód już w standardzie posiada praktycznie każdy możliwy system wspomagania jazdy – asystent martwego pola, asystent pasa ruchu, ostrzeganie przed kolizją z przodu i z tyłu, rozpoznawanie znaków drogowych czy nawet asystent przygotowania kabiny do potencjalnej kolizji. Z dodatkowych opcji wybraliśmy m.in.: czarne 22-calowe felgi doskonale pasujące do zielonego lakieru „Belgravia Green”, podgrzewane, wentylowane siedzenia przednie z funkcją masażu, elektrycznie regulowane w 24 kierunkach, podgrzewane i wentylowane tylne siedzenia pochylane elektrycznie, podgrzewaną kierownicę (idealną na zimowe dni), lodówkę w przedniej konsoli centralnej, wyświetlacz head-up oraz gniazdo elektryczne 230V.</p>
              <p :class="$style.cieszSiYciem">Nowa generacja flagowego Range’a zrobiła krok do przodu w każdym możliwym obszarze. Jest bardziej komfortowa, zwinniejsza i dynamiczniejsza (mimo wagi przekraczającej 2500 kg), lepiej wykonana oraz nowocześniejsza od swojego poprzednika. Stanowi bardzo ciekawą alternatywę dla niemieckich propozycji. Poziomem luksusu może konkurować nie tylko z innymi SUV-ami, ale także z typowymi limuzynami takimi jak BMW Serii 7, Audi A8 czy Mercedes S klasa.</p>
          </div>
