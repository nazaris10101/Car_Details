...
<template>
  <div :class="$style.carDetails">
      ...
      <div :class="$style.textImgsParent">
          <div :class="$style.textImgs">
              <div :class="$style.textImg">
                  <div :class="$style.textImg">
                      <div :class="$style.porsche911Carrera">Porsche 911 Carrera 4S</div>
                      <div :class="$style.text1">
                          <div :class="$style.porsche911Carrera">500Zł</div>
          ...
          <div :class="$style.textCardsButton">
              <div :class="$style.textCards">
                  <div :class="$style.porsche911Carrera">Specyfikacja techniczna</div>
                  <div :class="$style.cards">
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.porsche911Carrera">Skrzynia biegów</div>
                      ...
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.porsche911Carrera">Paliwo</div>
                      ...
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.porsche911Carrera">Drzwi</div>
                              <div :class="$style.automat">2</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                          <div :class="$style.text2">
                              <div :class="$style.porsche911Carrera">Klimatyzator</div>
                      ...
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.porsche911Carrera">Miejsca</div>
                              <div :class="$style.automat">2</div>
                          </div>
                      </div>
                      <div :class="$style.card">
                          ...
                          <div :class="$style.text2">
                              <div :class="$style.porsche911Carrera">Dystans</div>
              ...
              <div :class="$style.textIcons">
                  <div :class="$style.porsche911Carrera">Wyposażenie samochodu</div>
      ...
      <div :class="$style.banner">
          <div :class="$style.porsche911CarreraContainer">
              <p :class="$style.cieszSiYciem">Porsche 911 Carrera 4S</p>
              <p :class="$style.cieszSiYciem">Najnowsza generacja Porsche 911 (992) to kolejna ewolucja kultowego modelu. Porsche nie zdecydowało się na ryzykowną rewolucję, postawiło na zachowanie klasycznych dla 911 elementów, polepszając przy tym pod wieloma względami znaną nam konstrukcję. Nowoczesny wygląd nawiązujący do klasycznych modeli 911, z pewnością przypadnie do gustu wielbicielom tej marki. Wersja 4S przyśpiesza do 60mph (96 km/h) w 3.0 s i osiąga prędkość maksymalną 306km/h. To przyśpieszenie na poziomie poprzedniej generacji w topowej odmianie Turbo. Porsche 911 Carrera 4S stało się autem jeszcze bardziej użytecznym, nowocześniejszym, mocniejszym (o 30KM) oraz zdecydowanie szybszym. Najnowszy model 911 zmienił swoje oblicze.</p>
              <p :class="$style.cieszSiYciem">Konkurencyjne modele o podobnej mocy nie mogą się równać z osiągami, które prezentuje 992. Opcjonalna tylna oś skrętna, w którą wyposażony jest nasz egzemplarz, zapewnia jeszcze lepszą stabilność podczas pokonywania zakrętów. Świetne właściwości jezdne pojazdu w połączeniu z komfortem podróżowania sprawiają że samochód sprawdzi się zarówno na torze jak i podczas codziennych podróży. Szybszemu pokonywaniu zakrętów sprzyja również bardzo niska pozycja za kierownicą, nawet wśród wysokich kierowców. Precyzyjna automatyczna 8-stopniowa skrzynia biegów PDK idealnie pasuje do charakteru samochodu.</p>
              <p :class="$style.cieszSiYciem">Nowością jest również użycie nowoczesnego joysticku do zmiany przełożeń. Oferowana przez nas 911 posiada bardzo bogatą wersję wyposażenia, wśród której znajdują się elementy dodające jeszcze bardziej sportowego zacięcia. Na jej pokładzie można znaleźć m.in. Pakiet Sport Chrono zapewniający przełącznik trybów jazdy oraz dodatkowy 20-sekundowy boost „Sport Response”. Na dodatkowe elementy we wnętrzu zapewniające podwyższony komfort składają się 18-kierunkowe adaptacyjne fotele sportowe z wentylacją i podgrzewaniem, system nagłośnieniowy Bose, adaptacyjny tempomat, reflektory LED Matrix czy kamera 360 stopni. Całe wnętrze pojazdu jest doskonale wykonane, na poziomie typowym dla marki ze Stuttgartu. Model 911 4S, który znajduje się w naszej ofercie, sprawdzi się zarówno osobom, które potrzebują wyjątkowego samochodu do codziennych zadań oraz tym, którzy szukają mocnej dawki adrenaliny na krętych drogach! Zapraszamy do wypożyczenia samochodu i przekonaniu się dlaczego 911 jest topowym modelem sportowym.</p>
          </div>
