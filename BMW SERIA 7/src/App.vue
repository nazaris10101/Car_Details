        ...
        <div :class="$style.offParent">
          ...
          <div :class="$style.textImgsParent">
                <div :class="$style.textImgs">
                      <div :class="$style.textImg">
                            <div :class="$style.textImg">
                                  <div :class="$style.z">BMW SERIA 7 </div>
                                  <div :class="$style.text1">
                                        <div :class="$style.z">250Zł</div>
                      ...
                      <div :class="$style.textCards">
                            ...
                            <div :class="$style.cards">
                                  ...
                                  <div :class="$style.card">
                                        <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                                        <div :class="$style.text2">
                                              <div :class="$style.z">Klimatyzator</div>
          ...
          <div :class="$style.banner">
                <div :class="$style.bmwSerii7Container">
                      <p :class="$style.cieszSiYciem">BMW Serii 7 w najnowszej odsłonie robi olbrzymie technologiczne wrażenie. Bardzo nowoczesne wrażenie robi również z zewnątrz – z dużym grillem i bardzo ostrymi, wyrazistymi przednimi lampami. Zgodnie z trendami, wraz z nową siódemką zadebiutowała całkowicie elektryczna wersja i7, która za wyjątkiem niebieskich akcentów dookoła samochodu, nie różni się wieloma elementami wizualnymi od wersji spalinowej.</p>
                      <p :class="$style.cieszSiYciem">Najnowsze BMW Serii 7 oferuje jedno z najbardziej ekskluzywnych i nowoczesnych wnętrz spośród wszystkich dostępnych modeli na rynku. Dodatkowo jest wykonane ze świetnej jakości materiałów i jest równie bardzo dobrze spasowane. Topowa limuzyna niemieckiej marki waży ponad 2 tony, ale prowadzi się w sposób bardzo pewny, precyzyjny i prosty. Z pewnością pomaga w tym adaptacyjne zawieszenie pneumatyczne oraz tylna oś skrętna, które dostajemy w standardzie.</p>
                      <p :class="$style.cieszSiYciem">Pakiet M Sport oraz Sport M Pro w które wyposażone jest nasz egzemplarz, dodaje do wyposażenia 20 calowe felgi M Aero, sportowy układ hamulcowy M czarny, wielofunkcyjne fotele przednie, kierownicę sportową M, spoiler tylny i inne sportowe dodatki. Wszystko świetnie współgra z kolorem czarnym Carbon M. Wielki grill jest elementem przez wiele osób uważany za dyskusyjny, jednak w pakiecie Czerni dobrze komponuje się z resztą auta i jest proporcjonalny do całościowych wymiarów auta.</p>
                      <p :class="$style.cieszSiYciem">BMW 7 generacji G70 jest konstrukcją praktycznie całkowicie nową w porównaniu do poprzednika.Na przełomie czasu, niemieccy producenci przyzwyczaili nas do tego, że kiedy dochodzi do premiery nowej topowej limuzyny czy to Mercedesa S klasy,  Audi A8  czy BMW 7, zawsze zachwycają one nowymi i przełomowymi rozwiązaniami. Nie inaczej jest w przypadku nowej siódemki. Przykładowo, obydwa fotele z tyłu posiadają osobne tablety do sterowania całym samochodem, a nie jak „tradycyjnie” bywa jeden duży tablet na środku w podłokietniku. W naszym egzemplarzu postawiliśmy na sprawdzoną konfigurację napędową czyli 3 litrową jednostkę diesla w połączeniu z napędem na cztery koła. To gwarantuje świetne osiągi, rewelacyjną elastyczność, niskie zużycie paliwa, wysoki poziom bezpieczeństwa, a przede wszystkim radość z jazdy.</p>


                            <p :class="$style.cieszSiYciem">BMW 740D w ofercie Cylindersi</p>
                            <p :class="$style.cieszSiYciem">Model z Monachium z pewnością przypadnie do gustu wszystkim miłośnikom technologicznych nowinek. Jednak przede wszystkim spełni się również w najważniejszej dla niego roli, jaką jest podróżowanie w komfortowych i luksusowych warunkach, szczególnie podczas dłuższych podróży. Siódemka to również ważna i kultowa pozycja dla każdego miłośnika motoryzacji. Ten potężny diesel spełni oczekiwania nawet najbardziej wymagającego kierowcy.</p>
                            <p :class="$style.cieszSiYciem">Oferujemy kompleksowe usługi wynajmy samochodów luksusowych i sportowych w Warszawie oraz pozostałych miastach w Polsce. Jeśli mieszkasz poza terenem Warszawy, to nic nie stoi na przeszkodzie, abyś także skorzystał z naszej oferty. Sprawdź również ofertę na inne nasze samochody, dzięki którym znajdziesz niespotykane dotąd doznania.</p>
                            <p :class="$style.cieszSiYciem">Cena samochodów uzależniona jest od okresu wynajmu. Możesz się skontaktować z nami bezpośrednio, telefonicznie lub online, a fizyczne znajdziesz nas w jednym z trzech oddziałów: Warszawa, Katowice, Wrocław.</p>
                            </div>
