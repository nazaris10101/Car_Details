...
<template>
      <div :class="$style.carDetails">
              ...
              <div :class="$style.textImgsParent">
                      <div :class="$style.textImgs">
                              <div :class="$style.textImg">
                                      <div :class="$style.textImg">
                                              <div :class="$style.mercedesCls">Mercedes cls</div>
                                              <div :class="$style.text1">
                                                      <div :class="$style.mercedesCls">250Zł</div>
                      ...
                      <div :class="$style.textCardsButton">
                              <div :class="$style.textCards">
                                      <div :class="$style.mercedesCls">Specyfikacja techniczna</div>
                                      <div :class="$style.cards">
                                              <div :class="$style.card">
                                                      <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                                                      <div :class="$style.text2">
                                                              <div :class="$style.mercedesCls">Skrzynia biegów</div>
                                              ...
                                              <div :class="$style.card">
                                                      ...
                                                      <div :class="$style.text2">
                                                              <div :class="$style.mercedesCls">Paliwo</div>
                                              ...
                                              <div :class="$style.card">
                                                      ...
                                                      <div :class="$style.text2">
                                                              <div :class="$style.mercedesCls">Drzwi</div>
                                              ...
                                              <div :class="$style.card">
                                                      <img :class="$style.gearShift11Icon" alt="" src="@/assets/gear-shift(1) 1.svg" />
                                                      <div :class="$style.text2">
                                                              <div :class="$style.mercedesCls">Klimatyzator</div>
                                              ...
                                              <div :class="$style.card">
                                                      ...
                                                      <div :class="$style.text2">
                                                              <div :class="$style.mercedesCls">Miejsca</div>
                                                              <div :class="$style.automat">4</div>
                                                      </div>
                                              </div>
                                              <div :class="$style.card">
                                                      ...
                                                      <div :class="$style.text2">
                                                              <div :class="$style.mercedesCls">Dystans</div>
                              ...
                              <div :class="$style.textIcons">
                                      <div :class="$style.mercedesCls">Wyposażenie samochodu</div>
              ...
              <div :class="$style.banner">
                      <div :class="$style.mercedesZModelemContainer">
                              <p :class="$style.cieszSiYciem">Mercedes z modelem CLS zapoczątkował modę na auta w stylu coupe, które łączyły wymiar estetyczny z praktycznym. W oferowanym przez nas CLS 63 AMG S, producent zastosował silnik po modernizacji (zmniejszona pojemność z 6.3L na 5.5L!). Nie wpłynęło to jednak na pogorszenie parametrów auta.Wręcz przeciwnie, dzięki napędowi na cztery koła oraz podwójnemu turbodoładowaniu, ten luksusowy samochód rozpędza się do 100km/h w 3.6s!</p>
                              <p :class="$style.cieszSiYciem">Mercedes CLS świetnie łączy świat elegancji, praktyczności oraz osiągów supersamochodu.Świadczy o tym doskonale wykonane wnętrze auta, użycie materiałów na najwyższym poziom oraz smukła i muskularna sylwetka. Nadwozie mierzy prawie pięć metrów długości, co zapewnia odpowiednią ilość miejsca dla pasażerów tylnej kanapy. O parametrach godnych aut sportowych świadczy również potężny moment obrotowy wynoszący aż 800 Nm!</p>
                              <p :class="$style.cieszSiYciem">CLS 63 to nie tylko oszałamiające parametry. Dzięki swojej zmiennej charakterystyce (do dyspozycji mamy cztery tryby jazdy), równie dobrze spełni się w roli komfortowej limuzyny, jak i sportowej maszyny z wyjątkowo złowrogo brzmiącym wydechem.</p>
                              <p :class="$style.cieszSiYciem">Samochód wpasuje się idealnie w każdą okazję. Jest doskonałym wyborem na dłuższe trasy, a przy bardziej sportowej jeździe docenimy potężny zapas mocy. Mercedes CLS 63 AMG S zapewnia wszystkim podróżującym coraz rzadziej spotykany „klimat” oraz poczucie wyjątkowości.</p>
...
<script lang="ts">
      ...
      export default defineComponent({
              ...
              .textImgsParent {
                      ...
                      align-items: flex-start;
                      justify-content: center;
                      padding: 60px 157px 113px 159px;
                      box-sizing: border-box;
                      gap: 24px;
                      font-size: 24px;
                      color: #000;
              }
              .mercedesZModelemContainer {
                      width: 1246px;
                      position: relative;
                      line-height: 32px;
                      display: inline-block;
